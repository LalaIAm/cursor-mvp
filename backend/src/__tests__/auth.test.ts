...
describe('POST /api/auth/register', () => {
  ...
  beforeEach(async () => {
    ...
    // In a real scenario, you'd use a test database and clean it up
  });
...
describe('POST /api/auth/login', () => {
  ...
  beforeEach(async () => {
    ...
    const passwordHash = await hashPassword(validUser.password);
    // Note: This would need to be done in a test database setup
  });
